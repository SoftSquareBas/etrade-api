...
public class Rt02Controller {
	...
	// 	return () -> {
	// 		// Data data = rt02service.save(model);
	...
	@PostMapping("/delete")
	public Callable<Response> delete(@RequestBody Rt02Model model) {
		return () -> {
	...
	@PutMapping("/update")
	public Callable<Response> update(@RequestBody Rt02Model model) {
		return () -> {
	...
	// return Response.success(rt02service.searchDetail(model));
	// };
	// }
