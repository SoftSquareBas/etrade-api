...
public class CompanyRoleService {
	...
	public GridData search(final CompanyRoleModel model) {
		...
		sql.append(" 	WHERE sr.branch_id IS NULL ");
	...
	public Data load(final CompanyRoleModel model) {
	...
	public GridData loadAccessRight(final CompanyRoleModel model) {
		SqlParams params = SqlParams.create();
		StringBuilder sql = new StringBuilder();
	...
	public Data validate(final CompanyRoleModel model) {
	...
	private void saveAccesRight(final CompanyRoleModel model) {
		for (CompanyRoleModel.TransferItem item : model.getItems()) {
	...
	@Transactional
	public Data add(final CompanyRoleModel model) {
	...
	@Transactional
	public Data edit(final CompanyRoleModel model) {
	...
	@Transactional
	public Data delete(final CompanyRoleModel model) {
